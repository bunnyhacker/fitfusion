        ...
        <nav class="mt-2">
          ...
          <a href="../../../gallery.php" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../pageedit/gainedit.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>GAIN WEIGHT</p>
                </a>
              </li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>ADD WEIGHT GAIN DIET </h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">WEIGHT GAIN DIET</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form  action="gainedit.php" method="POST" enctype="multipart/form-data">
                  <div class="card-body">
...
if (isset($_POST['breakfast_submit'])) {
    ...
    // Handle file upload  
    $targetDirectory = "../../../../../intershiprepo/assets/gain/"; // Change this to your desired directory
    ...
    echo "<script>setTimeout(function ()
      {
        window.location.href='gainedit.php'
      },10000)</script>"; 
        $uploadOk = 0;
    }
  ...
  //   }
    ...
    $insert_query = "INSERT INTO `weight_gain`(`type`, `name`, `photo`, `calories`, `fat`, `protien`) VALUES ('$type','$d_name','$d_img','$d_cal','$d_fat','$d_prtn')";
    ...
    if ($result) {
      ...
      echo "<script>setTimeout(function ()
      {
        window.location.href='gainnedit.php'
      },10000)</script>";
    }
}
}
...
if (isset($_POST['lunch_submit'])) {
  ...
  //   }
    ...
    // Insert data into the database
    $lunch_insert_query = "INSERT INTO `weight_gain`(`type`, `name`, `photo`, `calories`, `fat`, `protien`) VALUES ('$type','$d_name','$d_img','$d_cal','$d_fat','$d_prtn')";
...
if (isset($_POST['dinner_submit'])) {
  ...
  //   }
    ...
    // Insert data into the database
    $dinner_insert_query = "INSERT INTO `weight_gain`(`type`, `name`, `photo`, `calories`, `fat`, `protien`) VALUES ('$type','$d_name','$d_img','$d_cal','$d_fat','$d_prtn')";
