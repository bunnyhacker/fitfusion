        ...
        <nav class="mt-2">
          ...
          <a href="../../../gallery.php" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../pageedit/maintainedit.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>MAINTAIN WEIGHT</p>
                </a>
              </li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>ADD MAINTAIN WEIGHT DIET </h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">WEIGHT MAINTAIN DIET</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form  action="maintainedit.php" method="POST" enctype="multipart/form-data">
                  <div class="card-body">
...
if (isset($_POST['breakfast_submit'])) {
    ...
    // Handle file upload  
    $targetDirectory = "../../../../../intershiprepo/assets/maintain/"; // Change this to your desired directory
    ...
    echo "<script>setTimeout(function ()
      {
        window.location.href='maintainedit.php'
      },10000)</script>"; 
        $uploadOk = 0;
    }
  ...
  //   }
    ...
    $insert_query = "INSERT INTO `weight_maintain`(`type`, `name`, `photo`, `calories`, `fat`, `protien`) VALUES ('$type','$d_name','$d_img','$d_cal','$d_fat','$d_prtn')";
...
if (isset($_POST['lunch_submit'])) {
  ...
  //   }
    ...
    // Insert data into the database
    $lunch_insert_query = "INSERT INTO `weight_maintain`(`type`, `name`, `photo`, `calories`, `fat`, `protien`) VALUES ('$type','$d_name','$d_img','$d_cal','$d_fat','$d_prtn')";
...
if (isset($_POST['dinner_submit'])) {
  ...
  //   }
    ...
    // Insert data into the database
    $dinner_insert_query = "INSERT INTO `weight_maintain`(`type`, `name`, `photo`, `calories`, `fat`, `protien`) VALUES ('$type','$d_name','$d_img','$d_cal','$d_fat','$d_prtn')";
